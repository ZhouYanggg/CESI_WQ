...
list.var <- c("ann_mean_flow", "pot_days", "pot_events",
              "pot_max_dur", "X1_day_max", "dr_days", "dr_events", "dut_max_dur", "X7_day_min")
list.var.name <- c("Annual Mean Flow", "Number of Flood Days",
                   "Number of Flood Events", "Maximum Flood Event Duration",
                   "Maximum 1-day Flow", "Number of Drought Days", "Number of Drought Events", 
                   "Maximum Drought Event Duration", "Minimum 7-day Flow")
